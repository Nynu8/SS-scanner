...
async function readConfigFile() {
  ...
  try {
    ...
    console.log(
      chalk.red("Configuration file was not found or could not be open")
    );
  }
}
...
module.exports = async function configurateSettings() {
  ...
  try {
    ...
    console.log(
      chalk`{blue Could not find {yellowBright raw_scans} directory, creating one}`
    );
  } catch (e) {
  ...
  try {
    ...
    console.log(
      chalk`{blue Could not find {yellowBright sheet_scans} directory, creating one}`
    );
  } catch (e) {
